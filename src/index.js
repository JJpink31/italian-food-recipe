...
function generateRecipe(event) {
   ...
   let instructionInput = document.querySelector("#user-instructions");
    ...
    let context=" You are talented chef with a lot of wisdom about Italain cuisine. Please generate an Italian recipe that has both ingredients and cooktime. Each line must have a <br />. Make sure to follow user instructions."
